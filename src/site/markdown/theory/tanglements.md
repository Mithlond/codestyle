...
The codestyle project within the Mithlond Codestyle reactor is based on the Nazgul Tools codestyle, 
and supplies enforcement rules, which - if in operation - prevents developers from importing implementation project 
dependencies into other implementation projects. It is recommended to import dependencies only on API/SPI or Model 
projects. Please refer to the Nazgul Tools Codestyle project for further details.
...
is another frightful example of legacy tanglements which can be avoided by using the Codestyle enforcement rules. 
